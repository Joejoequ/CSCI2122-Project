...
int main(int argc, char *argv[]) {
    ...
    Heap *locations = heap_initialize(sizeof(location), "location", location_strategy_path, location_print);
    for (int i = 0; i < 200; i++) {
    ...
    FILE *dead = fopen("strategy_dead", "w");
    FILE *alive = fopen("strategy_alive", "w");
    for (int i = 0; i < 300; i++) {
