...
int main(int argc, char *argv[]) {
    ...
    Heap *locations = heap_initialize(sizeof(location), "location", location_level_path, location_print);
    for (int i = 0; i < 200; i++) {
...
gettimeofday(&end,NULL);
    time_use=(end.tv_sec-start.tv_sec)*10000000+(end.tv_usec-start.tv_usec); 
